...
test("given the package entry point, when importing it, then exposes only native authoring helpers", async () => {
  const api = await import("../dist/index.js");
  assert.deepEqual(Object.keys(api).sort(), ["Fragment", "render", "stylesheet"]);
});
